...
export default function CalculadoraConcreto({
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (!c || !l || !h || c <= 0 || l <= 0 || h <= 0) {
      alert(
        "Preencha comprimento, largura e altura com valores válidos em metros."
      );
      return;
    }

    const elementoInfo =
      ELEMENTOS_CONCRETO.find((elemento) => elemento.id === tipoElemento) ??
    ...
    const sacosPorM3 = 7.5;
    const areiaPorM3 = 0.55;
    const britaPorM3 = 0.85;
    const aguaPorM3 = 180;

    const resultadoCalculado: ResultadoConcreto = {
      volume,
      volumeComPerda,
  ...
  function formatNumber(numero: number, casas: number = 2) {
      ...
      >
        ...
        <header style={{ marginBottom: "18px" }}>
          ...
          >
            ...
            o volume e a estimativa de materiais, já com uma recomendação para a
            usina.
          </p>
        </header>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              {ELEMENTOS_CONCRETO.map((elemento) => (
            ...
            >
              Essa escolha ajuda a sugerir o Fck, slump e tipo de brita mais
              adequados para esse tipo de elemento.
            </p>
          </div>
        ...
        {resultado && (
          ...
          >
            ...
            >
              ...
              {`Concreto para ${resultado.elementoLabel}, Fck ${
                resultado.fck
              } MPa, slump ${resultado.slump}, ${
                resultado.britaTipo
              }, volume de aproximadamente ${formatNumber(
                resultado.volumeComPerda,
                3
              )} m³ (já considerando perda).`}
            </p>
            ...
            >
              ...
              pode ajustar o traço, Fck e parâmetros conforme o projeto
