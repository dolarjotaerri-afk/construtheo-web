...
export default function CalculadoraBlocos({
  onVoltar,
}: CalculadoraBlocosProps) {
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const tipoBlocoInfo =
      TIPOS_BLOCOS.find((bloco) => bloco.id === tipoBloco) ??
      TIPOS_BLOCOS[0];
    ...
    const perdaPercent = Number.isNaN(p) ? 0 : p;
    const blocos = areaLiquida * tipoBlocoInfo.blocosPorM2;
    const blocosComPerda = blocos * (1 + perdaPercent / 100);
    const argamassaLitros =
      areaLiquida * tipoBlocoInfo.argamassaLPorM2;
    ...
    setResultado({
      ...
      tipoParedeLabel:
        TIPOS_PAREDE.find((parede) => parede.id === tipoParede)?.label ||
        "Parede",
    });
  }

  function format(numero: number, casas = 2) {
    ...
    >
      ...
      >
        ...
        <header style={{ marginBottom: "18px" }}>
          ...
          >
            Informe o tipo de bloco, medidas da parede e aberturas.
            Mostraremos a quantidade ideal de blocos e argamassa.
          </p>
        </header>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label htmlFor="tipoBloco" style={labelStyle}>
              Tipo de bloco
            </label>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label htmlFor="tipoParede" style={labelStyle}>
              Tipo da parede
            </label>
            ...
            >
              {TIPOS_PAREDE.map((parede) => (
                <option key={parede.id} value={parede.id}>
                  {parede.label}
                </option>
              ))}
            </select>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label htmlFor="altura" style={labelStyle}>
              Altura da parede (m)
            </label>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label htmlFor="comprimento" style={labelStyle}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label htmlFor="porta" style={labelStyle}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label htmlFor="janela" style={labelStyle}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label htmlFor="perda" style={labelStyle}>
              Perda (%) de blocos
            </label>
            ...
            >
              Perdas recomendadas: 5% para profissional, 8–12% para
              iniciante.
            </p>
          </div>
        ...
        {resultado && (
          ...
          >
            ...
            >
              {`Parede ${resultado.tipoParedeLabel}, ${
                resultado.tipoBlocoLabel
              }. Área líquida: ${format(
                resultado.areaLiquida,
                2
              )} m². Necessário: ${format(
                resultado.blocosComPerda,
                1
              )} blocos (considerando perdas). Argamassa estimada: ${format(
                resultado.argamassaLitros,
                0
              )} litros.`}
            </p>
            ...
            >
              Valores aproximados. O pedreiro pode ajustar perdas, tipo de
              bloco e argamassa conforme experiência.
            </p>
          </section>
        )}
      </div>
